			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					...
					<div class="product-details"><!--product-details-->
                        ...
                        <div class="col-sm-3">
                            <h3>For the sponsorship amount, the brand will be displayed</h3>
                            <a href="http://localhost/daddyspocket/tshirt/index.html" class="btn btn-primary">Start Designing</a>
                        </div>
					</div>
					<?php } ?>
				</div>
